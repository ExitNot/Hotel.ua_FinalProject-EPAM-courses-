...
//    GET commands
    ...
    public static final String AVAILABLE_ROOMS = "availableRoomsList";
//    POST commands
...
//    Parameters
    ...
    public static final String PARAM_FROM = "date_from";
    public static final String PARAM_TO = "date_to";
...
//    Pages JSP
    public static final String LOGIN_JSP = "signIn.jsp";
