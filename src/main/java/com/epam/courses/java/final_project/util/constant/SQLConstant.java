...
//    Users
    public static final String USER_INSERT = "INSERT INTO users (email, password, name, surname, phone_number, verification, role) VALUES (?, ?, ?, ?, ?, ?, ?);";
    public static final String USER_UPDATE = "UPDATE users SET email = ?, password = ?, name = ?, surname = ?, phone_number = ?, verification = ?, role = ? WHERE id = ?;";
