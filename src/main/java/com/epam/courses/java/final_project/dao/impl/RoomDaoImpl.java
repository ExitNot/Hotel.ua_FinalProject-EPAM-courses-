...
public class RoomDaoImpl implements RoomDao {
    ...
    public Optional<Room> getById(long id) {
        return Optional.ofNullable(JDBCManager.selectOneRequest(this, SQL_SELECT_BY, TABLE_ROOM, PARAM_ID, String.valueOf(id)));
    }

    @Override
    public Optional<Room> getByRoomNum(int roomNum) {
        return Optional.ofNullable(JDBCManager.selectOneRequest(this, SQL_SELECT_BY, TABLE_ROOM,
                PARAM_ROOM_NUM, String.valueOf(roomNum)));
    }
    ...
    public List<Room> getRoomsByFloor(int floor) {
        return JDBCManager.selectRequest(this, SQL_SELECT_BY, TABLE_ROOM,
                PARAM_FLOOR, String.valueOf(floor));
    }

    @Override
    public List<Room> getRoomsByCapacity(int capacity) {
        return JDBCManager.selectRequest(this, SQL_SELECT_BY, TABLE_ROOM,
                PARAM_CAPACITY, String.valueOf(capacity));
    }

    @Override
    public List<Room> getRoomsByBedsTypes(String bedsTypes) {
        return JDBCManager.selectRequest(this, SQL_SELECT_BY, TABLE_ROOM,
                PARAM_BED_TYPE, bedsTypes);
    }

    @Override
    public List<Room> getRoomsByClass(Room.RoomClass roomClass) {
        return JDBCManager.selectRequest(this, SQL_SELECT_BY, TABLE_ROOM,
                PARAM_CLASS, String.valueOf(roomClass.getValue()));
    }

    @Override
    public void update(Room obj) {
        JDBCManager.updateRequest(SQL_ROOM_UPDATE, String.valueOf(obj.getRoomNumber()),
                String.valueOf(obj.getFloor()), String.valueOf(obj.getCapacity()),
