...
<script>
    window.onload = function () {
        console.log(${cookie.waitingForResponseCB.value})
    }
</script>
                ...
                <form action="requestsList.act" method="get" class="row w-100 h-75 mt-3">
                    <div class="col-9">
                        <label class="form-check-label">
                            <c:choose>
                                <c:when test="${empty cookie.waitingForResponseCB.value}">
...
<%--                                <td>${request.roomNumber}</td>--%>
                                <td><input type="number" name="roomNumber" value="${request.roomNumber}"/></td>
                                <td>${request.from}</td>
                                <td>${request.to}</td>
                                <td>
                                    <c:choose>
                                ...
                                <td>
                                    <a class="link" href="#"
                                       onclick="document.getElementById('requestResponse').submit();">
                                        Response
                                    </a>
                                </td>
                                <td>
